...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const sidebarSections = useMemo<SidebarSection[]>(() => {
    ...
    const settingsChildren = compact<SidebarNode>([
      nested("settings-masters", "Masters", [
        ...
        navLeaf("GST Registration Master", "procurement_gst_billing_delivery_master", "/settings/purchase-order-masters/gst-registrations"),
        navLeaf("Billing / Delivery Addresses", "procurement_gst_billing_delivery_master", "/settings/purchase-order-masters?master=billing-delivery"),
        navLeaf("PO Terms & Conditions", "procurement_po_terms_master", "/settings/purchase-order-masters"),
        navLeaf("Site Contact Master", "procurement_site_contact_master", "/settings/purchase-order-masters/site-contacts"),
        navLeaf("Letterhead Master", "procurement_letterhead_master", "/settings/purchase-order-masters/letterheads"),
      ]),
  ...
  useEffect(() => {
    const pageKeyByPath: Record<string, string> = {
      ...
      "/labour": "labour_workspace",
      "/labour/workers": "labour_workers_register",
      "/labour/workers/new": "labour_registration",
