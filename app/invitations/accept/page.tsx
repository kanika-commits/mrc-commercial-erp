...
export default function InvitationAcceptPage() {
  ...
  if (state === "success") return <main className="mx-auto max-w-lg space-y-4 p-8"><h1 className="text-2xl font-semibold">Invitation accepted</h1><p>Your Tenant Administrator access is ready.</p><Link href="/" className="inline-block rounded-md bg-slate-950 px-4 py-2 text-sm font-semibold text-white">Continue to workspace</Link></main>;
