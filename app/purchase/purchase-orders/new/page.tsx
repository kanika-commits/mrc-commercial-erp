...
export default function NewPurchaseOrderPage() {
  ...
  const deliveryLocations = (lookups.delivery_locations || []).filter((row: any) => row.site_id === siteId && row.status === "active" && selectedBilling?.id && row.billing_address_id === selectedBilling.id).sort((a: any, b: any) => Number(b.is_default) - Number(a.is_default) || String(a.location_name || "").localeCompare(String(b.location_name || "")));
