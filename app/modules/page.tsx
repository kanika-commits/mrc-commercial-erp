...
const moduleCards = [
  ...
  },
  {
    ...
    href: "/modules/store-management",
    description: "Store workflows from the approved ERP structure.",
    checkModules: [],
    icon: Package,
    tone: "emerald",
    status: "Planned",
  ...
  },
  {
    ...
    description: "Masters, policies and password settings.",
    checkModules: ["companies", "sites", "vendors", "hr_departments", "hr_designations", "company_bank_accounts", "hr_employee_attendance_policy", "labour_muster_configuration", "labour_attendance_policy"],
    icon: Settings,
    tone: "emerald",
    status: "Active",
    meta: "System Setup",
...
const groupMeta: Record<string, (typeof moduleCards)[number]> = {
  project_management: moduleCards[0],
  store_management: moduleCards[1],
  purchase: moduleCards[2],
  accounts: moduleCards[3],
  settings: moduleCards[4],
  reports: moduleCards[5],
  administration: moduleCards[6],
  hr: {
    title: "Human Resources",
    href: "/modules/hr",
    description: "Employee registration, attendance, salary, reimbursement and labour muster.",
    checkModules: ["hr_employees", "hr_attendance", "reimbursements", "labour_workers", "labour_attendance"],
    icon: UsersRound,
    tone: "blue",
    status: "Pilot",
    meta: "HR Access",
  ...
  support: {
    ...
    description: "Support area from the approved ERP structure.",
    checkModules: [],
    icon: Package,
    tone: "violet",
    status: "Planned",
