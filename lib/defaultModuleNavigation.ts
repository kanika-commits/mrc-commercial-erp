const approvedNavigationModuleNames: Record<string, string> = {
  ...
  hr_attendance_register: "Attendance Register",
  work_orders: "Work Order",
  wo_approval: "Work Order Approval",
  purchase_requisitions: "Material Indent",
  purchase_requisition_approval: "Indent Approval",
  procurement_goods_receipts: "Purchase Order Tracking",
  procurement_inventory: "Inventory",
  procurement_purchase_queue: "Purchase Queue",
  ...
  procurement_items: "Item / Material Master",
...
const approvedNavigationRoutes: Record<string, string> = {
  ...
  "/labour/work-logs": "hr",
  "/labour/approvals": "hr",
  "/purchase/requisitions": "store_management",
  "/purchase/requisitions/approvals": "store_management",
  "/store/goods-receipts": "store_management",
  "/store/inventory": "store_management",
  "/store/inventory/issue": "store_management",
  "/purchase/queue": "purchase",
  "/purchase/purchase-orders": "purchase",
  "/purchase/requisitions/configuration": "settings",
  ...
  "/settings/policies/attendance-date-access": "settings",
...
export const DEFAULT_MODULE_NAVIGATION = filterVisibleModuleNavigation({
  ...
  modules: [
    ...
    {
      id: "default-purchase-requisitions",
      module_group: "store_management",
      module_code: "purchase_requisitions",
      module_name: "Material Indent",
      route: "/purchase/requisitions",
      sort_order: 0,
      status: "active",
    },
    {
      id: "default-purchase-requisition-approval",
      module_group: "store_management",
      module_code: "purchase_requisition_approval",
      module_name: "Indent Approval",
      route: "/purchase/requisitions/approvals",
      sort_order: 0.5,
      status: "active",
    },
    {
      id: "default-procurement-purchase-queue",
      module_group: "purchase",
      module_code: "procurement_purchase_queue",
      module_name: "Purchase Queue",
      route: "/purchase/queue",
      sort_order: 0.6,
      status: "active",
    },
    {
      id: "default-procurement-purchase-orders",
      module_group: "purchase",
    ...
    {
      id: "default-hr-attendance-register",
      module_group: "hr",
      module_code: "hr_attendance_register",
      module_name: "Attendance Register",
    ...
    {
      id: "default-procurement-items",
      module_group: "settings",
      module_code: "procurement_items",
      module_name: "Item / Material Master",
