...
assert.match(moduleSource, /item_code_snapshot/);
...
const oldMaterial = { revision_line_key: "material", item_name_snapshot: "Clamp", item_code_snapshot: "MAT001002", specification_snapshot: "250 GMS" };
const newMaterial = { ...oldMaterial, item_code_snapshot: "MAT00032", specification_snapshot: "230 GRM" };
assert.equal(diff(oldMaterial.item_code_snapshot, newMaterial.item_code_snapshot).state, "changed");
assert.equal(diff(oldMaterial.specification_snapshot, newMaterial.specification_snapshot).state, "changed");
assert.equal(diff(oldMaterial.item_name_snapshot, newMaterial.item_name_snapshot).state, "unchanged");
assert.equal(diff("250 GMS", "230 GRM").state, "changed");
